...
export default function EditInvoicePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      {/* Main content */}
      <div className="flex-1 grid grid-cols-[30%_70%] bg-white dark:bg-[#111827]">
        {/* Chat Interface */}
        <div className="relative">
          <div className="sticky top-3 flex flex-col bg-white dark:bg-[#111827] border-r border-gray-200 dark:border-[#1f2937] shadow-xl m-3 rounded-xl overflow-hidden h-[calc(100vh-1.5rem)]">
            {/* Header */}
            ...
            <div className="flex-shrink-0 bg-gray-100 dark:bg-[#1f2937] p-3 border-t border-gray-300 dark:border-[#1f2937]">
              <div className="flex gap-2 px-3">
                <textarea
                  ...
                  className="flex-1 p-2 rounded-lg bg-white dark:bg-[#111827] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-gray-300 dark:border-[#374151] focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 text-xs min-h-[38px] max-h-[150px] resize-none overflow-y-auto"
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className="px-4 py-2 bg-blue-500/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-500/40 text-xs transition-all duration-200 flex items-center gap-1.5 font-medium border border-blue-500/40 disabled:opacity-50 w-[88px] h-[38px] flex-shrink-0"
                >
                  {isProcessing ? (
                    <>
        ...
        {/* Google Doc */}
        <div className="h-full overflow-hidden bg-[#f8f9fa] dark:bg-[#1f2937]">
